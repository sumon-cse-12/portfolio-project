...
@section('title')WhatsApp Numbers @endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary float-right" href="{{route('customer.whatsapp.number.purchase')}}">{{trans('customer.purchase')}}</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="whatsappNumbers" class="table table-striped table-bordered dt-responsive nowrap">
                            <thead>
                            <tr>
...
@section('extra-scripts')
    ...
    <script>
        "use strict";
        $('#whatsappNumbers').DataTable({
            processing: true,
            serverSide: true,
            responsive:true,
            ajax:'{{route('customer.get.whatsapp.numbers')}}',
            columns: [
