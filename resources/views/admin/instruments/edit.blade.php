...
@section('title') {{ trans('admin.edit') }} {{ trans('admin.instruments') }}   @endsection
        ...
        <div class="col-12 mx-auto col-sm-10 mt-3">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">{{ trans('admin.edit') }} {{ trans('admin.instruments') }}  </h2>

                    <a class="btn btn-info float-right" href="{{ route('admin.instruments.index') }}">{{ trans('admin.back') }}</a>
                </div>
                <form method="post" role="form" id="instrumentsForm" action="{{ route('admin.instruments.update',[$instruments]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
...
@section('extra-scripts')
    ...
    <script>
        ...
        $(document).on("click", ".del_new_element", function(e) {
            const id=$(this).attr('data-id');
