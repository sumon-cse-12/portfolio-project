...
@section('title') {{ trans('admin.create') }} {{ trans('admin.contacts') }}   @endsection
        ...
        <div class="col-12 mx-auto col-sm-10 mt-3">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">{{ trans('admin.create') }} {{ trans('admin.contacts') }}</h2>
                </div>
                <form method="post" role="form" id="contacts_Form" action="{{ route('admin.contact.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
