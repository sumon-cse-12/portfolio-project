            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">@lang('admin.addon.addon')
                            <i  data-toggle="tooltip" data-placement="right" class="fa fa-question-circle alert-tooltip"
                                title="To get payment from customer admin has to install payment gateway addon.
                                Its very simple to install, just download the zip file and import it."></i>
                        </h2>
                        <div class="float-right">
                            @if(extension_loaded('zip'))
                                <a class="btn btn-primary"
                                   href="{{route('admin.addon.import')}}">@lang('admin.addon.import')</a>
                            @endif
                        </div>
                    </div>
                    <!-- /.card-header -->
