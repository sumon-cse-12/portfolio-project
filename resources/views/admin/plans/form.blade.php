        ...
        <div class="tab-content" id="vert-tabs-tabContent">
            ...
            <div class="tab-pane fade tab_panel" id="features" role="tabpanel" aria-labelledby="vert-tabs-features-tab">
                <div class="form-group mb-0">
                    <label class="text-label">{{trans('SMS Sending Limit')}} (<small>Per Month</small>)</label>
            ...
            <div class="tab-pane fade tab_panel" id="pricing" role="tabpanel" aria-labelledby="vert-tabs-pricing-tab">
                <div class="form-group">
                    ...
                    <input type="number" placeholder="{{trans('Unit SMS Price For Top Up')}}" name="sms_unit_price"
                           value="{{isset($plan)?$plan->sms_unit_price:(old('sms_unit_price')?old('sms_unit_price'):'')}}"
                           class="form-control">
                </div>
                <div class="form-group">
                    <label for="">{{trans('Free SMS Credit')}}</label>
                    <input type="number" name="free_sms_credit" placeholder="{{trans('Free SMS For This Plan')}}"
            ...
            <div class="tab-pane fade tab_panel" id="permission" role="tabpanel" aria-labelledby="vert-tabs-permission-tab">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="">{{trans('Enable For')}}</label>
                            <select name="enable_for" class="form-control">
                                <option {{isset($plan) && $plan->enable_for=='customer'?'selected':''}} value="customer">Customer</option>
                                <option {{isset($plan) && $plan->enable_for=='reseller'?'selected':''}} value="reseller">{{trans('Reseller')}}</option>
                            </select>
                        </div>
                    </div>
