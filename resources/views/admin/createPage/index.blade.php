            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">@lang('admin.page.list')</h2>
                        <div class="float-right">
                            <a class="btn btn-primary" href="{{route('admin.page.create')}}">@lang('admin.page.new_page')</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body table-body">
                        <table id="pages" class="table table-striped table-bordered dt-responsive nowrap">
                            ...
                            <tr>
                                ...
                                <th>@lang('admin.page.description')</th>
                                <th>@lang('admin.page.position')</th>
